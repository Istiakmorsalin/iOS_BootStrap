...
public class CheckMarkView: UIView {
    ...
    func drawRectChecked(rect: CGRect) {
        ...
        let checkmarkFillColor = #colorLiteral(red: 0.9960784314, green: 0.3803921569, blue: 0.6392156863, alpha: 1)
